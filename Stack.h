...
public:
  ...
  /**
   * Remove the top-most element from the stack and returns it.
   *
...
private:
  ...
  // COMMENT There is no need for a pointer. You can just allocate the
  // array on the stack.

    //Allocating on stack instead
    //made significant changes removing all references to object on heap in implementation
    //removed -> operator where necessary
  Array <T> myStack;
